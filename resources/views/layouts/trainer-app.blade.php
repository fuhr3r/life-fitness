        ...
        <div class="right menu">
            @if (Request::segment(1) == 'admin')
                <div class="ui item">
                    ...
                    {{--                    <img src="{{ URL::secure_asset('images/icons/sidebar/log-out.svg') }}" alt="" class="new trainer action">--}}
                </div>
                <div class="ui item">
                    <i class="user icon new user action"></i>
                    {{--                    <img src="{{ URL::secure_asset('images/icons/sidebar/log-out.svg') }}" alt="" class="new user action">--}}
                </div>
            @endif
            ...
            @endif
            <div class="ui item">
                <img src="{{ URL::secure_asset('images/icons/sidebar/log-out.svg') }}" alt="" class="log out action">
            </div>
        </div>
    </div>
</div>
...
<script src="{{ URL::secure_asset('js/jquery/jquery-3.2.1.min.js', array(), true) }}"></script>
<script src="{{ URL::secure_asset('semantic/semantic.js', array(), true) }}"></script>
...
<script src="{{ URL::secure_asset('js/vanilla-masker/vanilla-masker.min.js') }}"></script>
<script src="{{ URL::secure_asset('js/vanilla-masker/masks.js') }}"></script>
<script src="{{ URL::secure_asset('js/cep.js') }}"></script>
